function [nextBoard,nextHandles,cont] = AIpiecesquare(board,gameInfo,turn,depth,pieces)
%function nextBoard = AIpiecesquare(board,gameInfo,turn)
%This function handles the piece square table AI. It takes a 
...
objectiveFunction = @(board) PieceSquareModular(board,1);
