function [nextBoards]=horizontalGen(board,irow,icol)
%function [nextBoards]=horizontalGen(board,row,col)
%generates all possible horizontal moves for a piece-used by rook+queen
